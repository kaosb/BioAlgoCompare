...
def generate_html_report(data_df, metric, friedman_result, test_info, posthoc_matrix, cliff_delta, alpha,
                          cd_img, rank_img, posthoc_img, effect_img, vd_img):
    """
...
def perform_statistical_analysis_report(data_df, metric='best_fitness', alpha=0.05, output_file=None, StatisticalAnalysis=None):
    """
...
<p>Se requieren al menos 2 algoritmos con múltiples ejecuciones para realizar análisis estadísticos comparativos.</p>
        ...
        html_content = generate_html_report(
            data_df, metric, friedman_result, test_info, posthoc_matrix, cliff_delta, alpha,
            cd_img, rank_img, posthoc_img, effect_img, vd_img
        )

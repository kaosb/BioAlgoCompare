...
def modify_statistical_analysis():
    ...
    def new_method(cls, data_df, metric="best_fitness", alpha=0.05, output_file=None):
        ...
        return perform_statistical_analysis_report(
            data_df, metric, alpha, output_file, cls
        )
    ...
    setattr(
        ...
        staticmethod(new_method),
    )

    # Informar del éxito
    print("Método 'generate_statistical_analysis_report' reemplazado correctamente.")

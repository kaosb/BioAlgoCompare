...
if __name__ == "__main__":
    ...
    results = run_benchmark(
        algorithms, instances, runs=5, iterations=100, population=30, seed=42
    )
    ...
    plot_solution_quality(results, "Comparación de Calidad de Solución").savefig(
        "results/quality_comparison.png"
    )
    plot_execution_time(results, "Comparación de Tiempo de Ejecución").savefig(
        "results/time_comparison.png"
    )
    plot_convergence_comparison(results, "Comparación de Convergencia").savefig(

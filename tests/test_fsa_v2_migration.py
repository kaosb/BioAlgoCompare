"""
Tests para verificar la migración de FSA a la nueva arquitectura v2.
"""
...
from algorithms.fsa import FSA, Flamingo
from algorithms.fsa_v2 import FSAV2, FlamingoV2
from problems.vrp import VRPProblem


class TestFSAV2Migration:
    """Tests para la migración de FSA a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = FSA(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = FSAV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = Flamingo(test_problem)
        ind_v2 = FlamingoV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = FSAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = FSAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

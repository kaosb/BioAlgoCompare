"""
Tests para verificar la migración de SMA a la nueva arquitectura v2.
"""
...
from algorithms.sma_v2 import SMAV2, SlimeMouldV2
from problems.vrp import VRPProblem


class TestSMAV2Migration:
    """Tests para la migración de SMA a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = SMA(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = SMAV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = SlimeMould(test_problem)
        ind_v2 = SlimeMouldV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = SMAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = SMAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

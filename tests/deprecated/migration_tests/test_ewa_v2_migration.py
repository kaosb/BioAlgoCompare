"""
Tests para verificar la migración de EWA a la nueva arquitectura v2.
"""
...
from algorithms.ewa_v2 import EWAV2, EarthwormV2
from problems.vrp_v2 import VRPProblemV2


class TestEWAV2Migration:
    """Tests para la migración de EWA a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = EWA(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = EWAV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = Earthworm(test_problem)
        ind_v2 = EarthwormV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = EWAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = EWAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

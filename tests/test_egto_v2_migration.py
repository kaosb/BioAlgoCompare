"""
Tests para verificar la migración de EGTO a la nueva arquitectura v2.
"""
...
from algorithms.egto import EGTO, EnhancedGorilla
from algorithms.egto_v2 import EGTOV2, EnhancedGorillaV2
from problems.vrp import VRPProblem


class TestEGTOV2Migration:
    """Tests para la migración de EGTO a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = EGTO(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = EGTOV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = EnhancedGorilla(test_problem)
        ind_v2 = EnhancedGorillaV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = EGTOV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = EGTOV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

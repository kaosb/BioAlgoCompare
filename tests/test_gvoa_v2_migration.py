"""
Tests para verificar la migración de GVOA a la nueva arquitectura v2.
"""
...
from algorithms.gvoa import GVOA, Vulture
from algorithms.gvoa_v2 import GVOAV2, VultureV2
from problems.vrp import VRPProblem


class TestGVOAV2Migration:
    """Tests para la migración de GVOA a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = GVOA(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = GVOAV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = Vulture(test_problem)
        ind_v2 = VultureV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = GVOAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = GVOAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

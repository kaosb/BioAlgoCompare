"""
Tests para verificar la migración de GTO a la nueva arquitectura v2.
"""
...
from algorithms.gto import GTO, Gorilla
from algorithms.gto_v2 import GTOV2, GorillaV2
from problems.vrp import VRPProblem


class TestGTOV2Migration:
    """Tests para la migración de GTO a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = GTO(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = GTOV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = Gorilla(test_problem)
        ind_v2 = GorillaV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = GTOV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = GTOV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

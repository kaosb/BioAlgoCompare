"""
Tests para verificar la migración de RRO a la nueva arquitectura v2.
"""
...
from algorithms.rro import RRO, Raven
from algorithms.rro_v2 import RROV2, RavenV2
from problems.vrp import VRPProblem


class TestRROV2Migration:
    """Tests para la migración de RRO a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = RRO(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = RROV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = Raven(test_problem)
        ind_v2 = RavenV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = RROV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = RROV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

"""
Tests para verificar la migración de MRFO a la nueva arquitectura v2.
"""
...
from algorithms.mrfo import MRFO, MantaRay
from algorithms.mrfo_v2 import MRFOV2, MantaRayV2
from problems.vrp import VRPProblem


class TestMRFOV2Migration:
    """Tests para la migración de MRFO a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = MRFO(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = MRFOV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = MantaRay(test_problem)
        ind_v2 = MantaRayV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = MRFOV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = MRFOV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

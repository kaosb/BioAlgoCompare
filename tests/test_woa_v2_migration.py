"""
Tests para verificar la migración de WOA a la nueva arquitectura v2.
"""
...
from algorithms.woa import WOA, Whale
from algorithms.woa_v2 import WOAV2, WhaleV2
from problems.vrp import VRPProblem


class TestWOAV2Migration:
    """Tests para la migración de WOA a v2."""
    ...
    def test_initialization_compatibility(self, test_problem):
        ...
        v1 = WOA(test_problem, population_size=pop_size, 
                                         max_iterations=max_iter, seed=seed)
        v2 = WOAV2(test_problem, population_size=pop_size, 
                                           max_iterations=max_iter, seed=seed)
    ...
    def test_individual_creation(self, test_problem):
        ...
        ind_v1 = Whale(test_problem)
        ind_v2 = WhaleV2(test_problem)
        ind_v2.initialize()
    ...
    def test_reproducibility(self, test_problem):
        ...
        v2_1 = WOAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)
        best_v2_1 = v2_1.execute()
        
        v2_2 = WOAV2(test_problem, population_size=pop_size, 
                                             max_iterations=max_iter, seed=seed)

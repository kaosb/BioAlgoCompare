...
```bash
python scripts/run.py --algorithm ewa --instance P-n16-k8 --iterations 100 --population 30
```
...
```bash
python scripts/run.py --algorithm all --instance E-n22-k4 --runs 3 --parallel
```
...
python scripts/run.py --algorithm foa --instance P-n16-k8 --iterations 100 --seed 42
python scripts/run.py --algorithm ewa --instance P-n16-k8 --iterations 100 --seed 42
...
python scripts/run.py --algorithm gto --instance E-n22-k4 --iterations 10 --seed 123
python scripts/run.py --algorithm gto --instance E-n22-k4 --iterations 100 --seed 123
python scripts/run.py --algorithm gto --instance E-n22-k4 --iterations 1000 --seed 123
```

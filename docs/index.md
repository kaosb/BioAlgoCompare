...
- Documentación Individual de Algoritmos:
  ...
  - [Flamingo Search Algorithm (FSA)](algorithms/individual/fsa.md)
...
- [Metodología](analysis/methodology.md) - Metodología empleada en los análisis
...
- [Conclusiones](analysis/conclusions.md) - Conclusiones y recomendaciones generales

...
## Checklist de Migración para GTO

### Archivos generados:
- [ ] algorithms/gto_v2.py
- [ ] tests/test_gto_v2_migration.py
...
best_gorilla, C, L, W, beta, p, iteration, max_iter, population

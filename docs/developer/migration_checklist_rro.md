...
## Checklist de Migración para RRO

### Archivos generados:
- [ ] algorithms/RRO_v2.py
- [ ] tests/test_RRO_v2_migration.py
...
target_position, Rpcpt, Npcpt, Nsteps, Pstop

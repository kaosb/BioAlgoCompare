...
## Checklist de Migración para GVOA

### Archivos generados:
- [ ] algorithms/GVOA_v2.py
- [ ] tests/test_GVOA_v2_migration.py
...
leader_pos, informed_positions, phase, r, it, max_it

...
## Checklist de Migración para SMA

### Archivos generados:
- [ ] algorithms/sma_v2.py
- [ ] tests/test_sma_v2_migration.py
...
2. **Clase Individual (SlimeMouldV2)**
...
best_mould, population, z, t, max_t

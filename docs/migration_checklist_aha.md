...
## Checklist de Migración para AHA

### Archivos generados:
- [ ] algorithms/aha_v2.py
- [ ] tests/test_aha_v2_migration.py
...
2. **Clase Individual (HummingbirdV2)**
...
population, iteration, max_iterations

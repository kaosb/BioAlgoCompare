...
class VRPProblem:
    ...
    def __init__(self, instance_path: str) -> None:
        ...
        self.nodes: List[Tuple[float, float]] = []  # Lista de coordenadas (x, y) de cada nodo
        self.demands: List[int] = []  # Demanda de cada nodo
        self.distance_matrix: Optional[np.ndarray] = None
        self.penalty_factor: float = PENALTY_FACTOR  # Factor de penalización para rutas no factibles
    ...
    def decode_solution(self, solution: np.ndarray) -> Tuple[List[List[int]], float, bool]:
        """
    ...
    def evaluate_routes_detailed(self, routes: List[List[int]]) -> Tuple[float, Dict[str, float], List[str]]:
        """

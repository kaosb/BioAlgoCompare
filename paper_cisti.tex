...
\begin{table}[ht]
  ...
  \begin{tabular}{clS[table-format=2.2]}
    \toprule
    \textbf{Posición} & \textbf{Algoritmo} & {\textbf{Ranking}} \\
    \midrule
...
Como se observa en la Fig.~\ref{fig:cost_quality}, existe una clara relación entre el coste computacional y la calidad de las soluciones obtenidas. Esta visualización confirma que SMA ofrece la mejor relación coste-calidad, situándose más cerca del origen (menor tiempo, menor fitness). RRO, a pesar de su rendimiento aceptable en fitness, resulta impracticable debido a su elevado coste computacional.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lS[table-format=1.6]S[table-format=1.6]S[table-format=1.6]S[table-format=1.6]S[table-format=1.6]}
    ...
    & {WOA} & {MRFO} & {SMA} & {GTO} & {AHA} \\
    \midrule
    WOA  & {0.5000} & {0.6111} & {0.5278} & {\textbf{0.7222}} & {\textbf{1.0000}} \\
    MRFO & {0.3889} & {0.5000} & {0.5000} & {\textbf{0.7222}} & {\textbf{1.0000}} \\
    SMA  & {0.4722} & {0.5000} & {0.5000} & {\textbf{0.6944}} & {\textbf{1.0000}} \\
    GTO  & {\textbf{0.2778}} & {\textbf{0.2778}} & {\textbf{0.3056}} & {0.5000} & {\textbf{1.0000}} \\
    AHA  & {\textbf{0.0000}} & {\textbf{0.0000}} & {\textbf{0.0000}} & {\textbf{0.0000}} & {0.5000} \\
    \bottomrule
  \end{tabular}
\end{table}

...
El test de Friedman alineado arrojó χ²(15)=123.4, p<0.001, confirmando diferencias estadísticamente significativas entre los algoritmos evaluados. La Tabla~\ref{tab:rankings} muestra el ranking general de los algoritmos según este test, promediando su rendimiento en todas las instancias Solomon.

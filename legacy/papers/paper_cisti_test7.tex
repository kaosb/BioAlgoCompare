...
\title{Documento Test 7}
\author{Test Author}
\maketitle

\begin{abstract}
Prueba con configuracion de listings corregida.
\end{abstract}

\section{Introduccion}
Probando valores numericos: \SI{16}{\giga\byte}, \SI{1.7}{\milli\second}.

\begin{lstlisting}[language=Python]
# Un ejemplo de codigo Python
def hello_world():
    print("Hola mundo")
\end{lstlisting}
